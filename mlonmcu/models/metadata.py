...
class ModelMetadata:
    ...
    def __init__(self, author="unknown", description="", created_at=None, references=None, comment=None, backend_options_map=None):
        ...
        self.backend_options_map = backend_options_map if backend_options_map is not None else {}
...
class TfLitelMetadata(ModelMetadata):
    ...
    def __init__(self, author="unknown", description="", created_at=None, references=None, comment=None, backend_options_map=None, operators=[]):
        super().__init__(author=author, description=description, created_at=created_at, references=references, comment=comment, backend_options_map=backend_options_map, operators=operators)
        ...
        try:
            ...
            if "backends" in content:
                ...
                for backend in backends:
                    backend_options = parse_model_options_for_backend(backend, backends[backend])
