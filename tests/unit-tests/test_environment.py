...
def test_environment_initialize_environment_duplicate(fake_environment_directory, fake_working_directory, fake_config_home):
    with mock.patch("mlonmcu.environment.templates.get_template_text", return_value=str.encode("---")) as mocked:
        before = _count_envs(fake_config_home)
        initialize_environment(fake_environment_directory, "myenv", interactive=False, create_venv=False, clone_models=False, register=True, template="default")
        initialize_environment(fake_working_directory, "myenv", interactive=False, create_venv=False, clone_models=False, register=True, template="default")
