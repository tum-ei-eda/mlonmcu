...
class Setup:
    ...
    def generate_requirements(
        ...
        def feature_enabled_and_supported(obj, feature):
            if getattr(obj, "enabled", True):
                if getattr(obj, "name", None) == feature and getattr(obj, "supported", False):
                    ...
                    enabled_and_supported = False
                    for k, v in obj.__dict__.items():
                        if isinstance(v, list):
                            for i in v:
                                enabled_and_supported = enabled_and_supported or feature_enabled_and_supported(i, feature)
        ...
        with open(output_dir, "w") as f:
            ...
            config_pools = self.context.environment.frameworks \
