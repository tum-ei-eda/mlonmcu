...
def main():
    ...
    parser.add_argument("-m", "--mode", choices=["esp32_perf", "etiss_sim", "esp32_real", "compare_esp32_and_etiss"], required=True,
                        help="Choose the run mode: esp32_perf, sim, esp32_real, or compare_esp32_and_etiss")
    parser.add_argument("-w", "--wait", type=int, choices=[0, 1], default=1,
                        help="Set espidf.wait_for_user to 1 or 0 (default: 0)")
    parser.add_argument("-o", "--opt", choices=['0', '2', 's'], default='s',
                    help="Compiler optimization level: 0, 2, or s (default: s)")
    ...
    cmd_esp32_perf = textwrap.dedent(f"""\
        ...
        -c espidf.install_dir=/usr/local/research/projects/SystemDesign/tools/esp/v5.4.1/espressif_py310 \
        -c espidf.src_dir=/usr/local/research/projects/SystemDesign/tools/esp/v5.4.1/esp-idf \
        ...
        -f autotuned \
        -c autotuned.results_file=/usr/local/research/projects/SystemDesign/work/performance-evaluation/varghese/Micro-KWS/micro-kws/2_deploy/data/micro_kws_student_tuning_log_nchw_best.txt \
        -c espidf.project_template=micro_kws_esp32devboard_perf -c espidf.wait_for_user={args.wait} \
        -c riscv_gcc_rv32.install_dir=/usr/local/research/projects/SystemDesign/tools/esp/v5.4.1/espressif_py310/tools/riscv32-esp-elf/esp-14.2.0_20241119/riscv32-esp-elf -c riscv_gcc_rv32.name=riscv32-esp-elf \
    ...
    cmd_etiss_sim = textwrap.dedent(f"""\
        ...
        -c espidf.install_dir=/usr/local/research/projects/SystemDesign/tools/esp/v5.4.1/espressif_py310 \
        -c espidf.src_dir=/usr/local/research/projects/SystemDesign/tools/esp/v5.4.1/esp-idf \
        -c run.export_optional=1 \
        --backend tvmaotplus -c tvmaotplus.desired_layout=NCHW -c tvmaot.desired_layout=NCHW \
        -f autotuned \
        -c autotuned.results_file=/usr/local/research/projects/SystemDesign/work/performance-evaluation/varghese/Micro-KWS/micro-kws/2_deploy/data/micro_kws_student_tuning_log_nchw_best.txt \
        -c riscv_gcc_rv32.install_dir=/usr/local/research/projects/SystemDesign/tools/esp/v5.4.1/espressif_py310/tools/riscv32-esp-elf/esp-14.2.0_20241119/riscv32-esp-elf -c riscv_gcc_rv32.name=riscv32-esp-elf \
        -c etiss_perf.src_dir=/usr/local/research/projects/SystemDesign/work/performance-evaluation/varghese/PerformanceSimulation_workspace/etiss-perf-sim/etiss/ \
        -c etiss_perf.fpu=none -c etiss_perf.atomic=0 -c etiss_perf.compressed=0 \
        -c etiss_perf.install_dir=/usr/local/research/projects/SystemDesign/work/performance-evaluation/varghese/PerformanceSimulation_workspace/etiss-perf-sim/etiss/build_dir/installed \
        -c etiss_perf.exe=/usr/local/research/projects/SystemDesign/work/performance-evaluation/varghese/PerformanceSimulation_workspace/etiss-perf-sim/etiss/build_dir/installed/bin/bare_etiss_processor \
        -f perf_sim -c mlif.optimize={args.opt} -c perf_sim.core=esp32c3
    """)
    ...
    cmd_esp32_real = textwrap.dedent(f"""\
        ...
        -c autotuned.results_file=/usr/local/research/projects/SystemDesign/work/performance-evaluation/varghese/Micro-KWS/micro-kws/2_deploy/data/micro_kws_student_tuning_log_nchw_best.txt \
        -c espidf.project_template=micro_kws_esp32devboard_perf -c espidf.wait_for_user={args.wait} \
        -c riscv_gcc_rv32.install_dir=/usr/local/research/projects/SystemDesign/tools/esp/v5.4.1/espressif_py310/tools/riscv32-esp-elf/esp-14.2.0_20241119/riscv32-esp-elf \
    ...
    if args.mode == "esp32_perf":
        ...
        #result_esp32 = 25360090, 21403066, 1.184881175
        #result_etiss = 24764915, 21637834, 1.144519133
        if result_esp32 and result_etiss:
            ...
            print(f"{'Run Cycles':<25}{esp32_cycles:>15}{etiss_cycles:>20}{percent_diff(esp32_cycles, etiss_cycles):>19.2f}%")
            print(f"{'Run Instructions':<25}{esp32_instructions:>15}{etiss_instructions:>20}{percent_diff(esp32_instructions, etiss_instructions):>19.2f}%")
            ...
            print(f"{'Device':<25}{'Instructions':>15}{'Cycles':>20}{'CPI':>20}{'CPI Error (%)':>20}{'Norm. CPI Error (%)':>25}{'Benefit (%)':>20}")
            print("-" * 145)
            print(f"{'ESP32-C3':<25}{esp32_instructions:>15}{esp32_cycles:>20}{esp32_cpi:>20.6f}{percent_diff(esp32_cpi, esp32_cpi):>19.2f}%{percent_diff(esp32_cpi, esp32_cpi):>24.2f}%")
            print(f"{'ISS (CPI = 1)':<25}{etiss_instructions:>15}{etiss_instructions:>20}{iss_cpi:>20.6f}{iss_cpi_err:>19.2f}%{iss_cpi_err_norm:>24.2f}%{iss_cpi_err_norm-iss_cpi_err_norm:>19.2f}%")
            print(f"{'ETISS':<25}{etiss_instructions:>15}{etiss_cycles:>20}{etiss_cpi:>20.6f}{etiss_cpi_err:>19.2f}%{etiss_cpi_err_norm:>24.2f}%{iss_cpi_err_norm-etiss_cpi_err_norm:>19.2f}%")
            print("-" * 145)
