...
class Session:
   ...
   #      pass
    ...
    def process_runs(self, until=RunStage.DONE, per_stage=False, num_workers=1, progress=False, context=None):
        ...
        def _init_progress(total, msg="Processing..."):
            global pbar
            pbar = tqdm(total=total, desc=msg, ncols=100, bar_format='{l_bar}{bar}| {n_fmt}/{total_fmt}')
